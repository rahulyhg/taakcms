...
<html>
<head>
    <title>getFullContents JSON</title>
</head>
<body>
    <a href="index.php?id=api/index">index</a>
    <h1>getFullContents JSON</h1>
    <form method="POST">
    ...
    <p>
        Post JSON data here to get contents for a subcategory.
    </p>
    <p>
        The getFullContents requires at least one parameter: subcategory_id.
    </p>
    <p>
