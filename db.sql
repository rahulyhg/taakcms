...
--
-- Host: localhost
-- Generation Time: Jul 07, 2019 at 12:25 PM
...
CREATE TABLE IF NOT EXISTS `tbl_contents` (
  ...
  `description` varchar(2000) COLLATE utf8_persian_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_content_details` (
  ...
  `field_value` varchar(2000) COLLATE utf8_persian_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
(1, 'admin', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'admin', 'admin', '')
